    ...
    <header className="border-b bg-white/80 backdrop-blur-md sticky top-0 z-50 shadow-sm">
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <Link href="/faq" className="text-slate-600 hover:text-black transition-colors font-medium">
            FAQ
          </Link>
          <a 
          ...
          <div className="max-w-7xl mx-auto px-6 py-6">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              ...
              <div className="flex gap-6">
                <a href="/pricing" className="text-sm text-slate-500 hover:text-black transition-colors">
                  Pricing
                </a>
                <a href="/faq" className="text-sm text-slate-500 hover:text-black transition-colors">
                  FAQ
                </a>
                <a href="/privacy" className="text-sm text-slate-500 hover:text-black transition-colors">
                  Privacy Policy
                </a>
                <a href="/terms" className="text-sm text-slate-500 hover:text-black transition-colors">
                  Terms of Service
                </a>
              </div>
            </div>
